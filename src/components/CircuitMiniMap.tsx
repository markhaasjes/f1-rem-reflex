...
export function CircuitMiniMap({ fixture }: CircuitMiniMapProps) {
  ...
  return (
    ...
    >
      <polyline points={points} fill="none" stroke="#101d63" strokeWidth={22} strokeLinecap="round" strokeLinejoin="round" />
      <polyline points={points} fill="none" stroke="white" strokeWidth={14} strokeLinecap="round" strokeLinejoin="round" />
      ...
      <g transform={`translate(${startFinish.x} ${startFinish.y}) rotate(${startFinish.headingDeg + 90})`}>
        ...
        <line x1={-16} y1={0} x2={16} y2={0} stroke="#111827" strokeWidth={7} strokeLinecap="round" strokeDasharray="3.5 3.5" />
      </g>
